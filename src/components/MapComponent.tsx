        ...
        function initMap() {
            ...
            map.on("load", () => {
                ...
                points.forEach((p) => {
                    ...
                    const width = typeof markerConfig.width === "number" 
                        ? `${markerConfig.width}px` 
                        : markerConfig.width ?? "20px"
                    const height = typeof markerConfig.height === "number" 
                ...
                <div className={`side-menu ${menuOpen ? "" : "closed"}`}>
                    {points.map((p, i) => (
                        <div key={p.id ?? i} className="menu-card">
                            ...
                            <button onClick={() => handleViewPoint(p, i)}>
                                View
                            </button>
                        </div>
                    ))}
